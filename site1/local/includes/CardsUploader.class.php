...
class CardsUploader
{
    ...
    public function uploadToFTP()
    {
        if (! $this->error) {
            ...
            $arFilter = array('IBLOCK_ID' => IB_SETTINGS, 'ACTIVE' => 'Y', 'CODE' => CARDS_FTP_FOLDER);
    ...
    {
        if (! $this->error) {
            $_SESSION["CARD_FILE"] = array("FILE_NAME" => $this->fileName, "ORIG_FILE_NAME" => $this->origFileName);
        }
