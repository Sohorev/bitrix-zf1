<?php
/**
 * Class Quickpay_Validate_Bitrix_Webform_Regex
 */
class Quickpay_Validate_Bitrix_Webform_Regex extends Quickpay_Validate_Bitrix_Webform {
    /**
     * @return array
     */
    public static function getDescription() {
        return self::getMetadata(
            "Quickpay_Validate_Bitrix_Webform_Regex",
            "zv_regex",
            self::t("Regex"),
            "text"
        );
