<?php
/**
 * Class Quickpay_Form_Abstract
 */
class Quickpay_Form_Abstract extends Zend_Form {
    ...
    public function __construct($options = null) {
        $this->addElementPrefixPath('Quickpay_Validate', 'Quickpay/Validate/', 'validate');
        $this->addElementPrefixPath('App_Validate', APPLICATION_PATH . '/validators', 'validate');
        $this->addPrefixPath('Quickpay_Form_Element', 'Quickpay/Form/Element/', 'element');
